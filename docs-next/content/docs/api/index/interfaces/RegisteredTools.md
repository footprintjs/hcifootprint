...
Defined in: [src/traverse/session.ts:185](https://github.com/footprintjs/hcifootprint/blob/main/src/traverse/session.ts#L185)
...
Defined in: [src/traverse/session.ts:194](https://github.com/footprintjs/hcifootprint/blob/main/src/traverse/session.ts#L194)
