...
Defined in: [src/tree/types.ts:71](https://github.com/footprintjs/hcifootprint/blob/main/src/tree/types.ts#L71)
...
Defined in: [src/tree/types.ts:73](https://github.com/footprintjs/hcifootprint/blob/main/src/tree/types.ts#L73)
