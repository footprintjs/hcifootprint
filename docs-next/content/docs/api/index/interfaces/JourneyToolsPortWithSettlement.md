---
title: JourneyToolsPortWithSettlement
---
...
Defined in: [src/serve/modes.ts:156](https://github.com/footprintjs/hcifootprint/blob/main/src/serve/modes.ts#L156)
...
[`JourneyToolsPort`](/api/index/interfaces/JourneyToolsPort).[`call`](/api/index/interfaces/JourneyToolsPort#call)
...
Defined in: [src/serve/modes.ts:224](https://github.com/footprintjs/hcifootprint/blob/main/src/serve/modes.ts#L224)
...
[`JourneyToolsPort`](/api/index/interfaces/JourneyToolsPort).[`settledAnswer`](/api/index/interfaces/JourneyToolsPort#settledanswer)
...
[`JourneyToolsPort`](/api/index/interfaces/JourneyToolsPort).[`tools`](/api/index/interfaces/JourneyToolsPort#tools)
...
[`JourneyToolsPort`](/api/index/interfaces/JourneyToolsPort).[`whenSettled`](/api/index/interfaces/JourneyToolsPort#whensettled)
