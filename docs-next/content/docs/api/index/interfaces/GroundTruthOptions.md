...
Defined in: [src/atom/types.ts:2245](https://github.com/footprintjs/hcifootprint/blob/main/src/atom/types.ts#L2245)
...
Defined in: [src/atom/types.ts:2247](https://github.com/footprintjs/hcifootprint/blob/main/src/atom/types.ts#L2247)
