...
Defined in: [src/traverse/session.ts:6637](https://github.com/footprintjs/hcifootprint/blob/main/src/traverse/session.ts#L6637)
...
Defined in: [src/traverse/session.ts:4875](https://github.com/footprintjs/hcifootprint/blob/main/src/traverse/session.ts#L4875)
