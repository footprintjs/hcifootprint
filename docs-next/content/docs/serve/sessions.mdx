...
it holds, nothing changes and the settlement carries `verified: true`. If it does not, the
...
(isolated, warned) comes back `verified: 'unevaluable'`. A refusal needs proof; a confirmation
