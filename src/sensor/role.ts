 ...
 * library has (atom/types.ts:71-76: "role + accessible name, never CSS classes").
 *
 ...
 * is invented. An unrecognised element must never be silently promoted to
 * "probably a button" — that guess would put a human's name on motion the sensor
 * did not actually recognise.
 *
